...
import com.jusipat.astikorcartsredux.client.renderer.entity.CargoCartRenderState;
...
public class HandCartModel extends CargoCartModel<CargoCartRenderState> {
    ...
    public static LayerDefinition createLayer() {
        final MeshDefinition def = createDefinition(7, 20);
        ...
        final EasyMeshBuilder body = createBody(7);
        body.addChild(axis);
