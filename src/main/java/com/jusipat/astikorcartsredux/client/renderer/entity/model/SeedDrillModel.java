...
public class SeedDrillModel extends CartModel<SeedDrillEntity> {
    ...
    @Override
    public void setupAnim(final SeedDrillEntity entity, final float delta, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float pitch) {
        super.setupAnim(entity, delta, limbSwingAmount, ageInTicks, netHeadYaw, pitch);
    }

    public static LayerDefinition createLayer() {
        final MeshDefinition def = createDefinition(9, 30);
        ...
        final EasyMeshBuilder body = createBody(9);
        body.addChild(axis);
        body.addChild(parts);
