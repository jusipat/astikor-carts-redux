...
public class SeedDrillScreen extends AbstractContainerScreen<SeedDrillMenu> {
    private static final ResourceLocation SEED_DRILL_GUI_TEXTURES = ResourceLocation.fromNamespaceAndPath(AstikorCartsRedux.MODID, "textures/gui/container/seed_drill.png");
