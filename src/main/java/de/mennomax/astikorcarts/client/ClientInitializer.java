...
public final class ClientInitializer {
    ...
    static {
        ...
        Material composterSide = new Material(ResourceLocation.withDefaultNamespace("block/composter_side"), 16).fill(16, 47, 44, 5, Material.R0, -2, 1)
        ...
        for (WoodType type : AstikorItems.VANILLA_WOOD_TYPES) {
            String logName = LOG_NAME_OVERRIDE.getOrDefault(type, "log");

            factory.add(ResourceLocation.fromNamespaceAndPath(AstikorCarts.ID, "textures/entity/" + type.name() + "_animal_cart.png"), new AssembledTexture(64, 64)
                ...
                .add(ResourceLocation.fromNamespaceAndPath(AstikorCarts.ID,"textures/entity/" + type.name() + "_plow.png"), new AssembledTexture(64, 64)
                        .add(new Material(ResourceLocation.withDefaultNamespace("block/" + type.name() + "_planks"), 16)
                ...
                .add(ResourceLocation.fromNamespaceAndPath(AstikorCarts.ID,"textures/entity/" + type.name() + "_seed_drill.png"), new AssembledTexture(64, 64)
                        .add(new Material(ResourceLocation.withDefaultNamespace("block/" + type.name() + "_planks"), 16)
                                .fill(0, 0, 64, 32, Material.R90)
                ...
                .add(ResourceLocation.fromNamespaceAndPath(AstikorCarts.ID,"textures/entity/" + type.name() + "_reaper.png"), new AssembledTexture(64, 64)
                        .add(new Material(ResourceLocation.withDefaultNamespace("block/" + type.name() + "_planks"), 16)
                                .fill(0, 0, 64, 32, Material.R90)
                ...
                .add(ResourceLocation.fromNamespaceAndPath(AstikorCarts.ID,"textures/entity/" + type.name() + "_supply_cart.png"), new AssembledTexture(64, 64)
                        .add(new Material(ResourceLocation.withDefaultNamespace("block/" + type.name() + "_planks"), 16)
                ...
                .add(ResourceLocation.fromNamespaceAndPath(AstikorCarts.ID,"textures/entity/" + type.name() + "_hand_cart.png"), new AssembledTexture(64, 64)
                        .add(new Material(ResourceLocation.withDefaultNamespace("block/" + type.name() + "_planks"), 16)
