...
//        });
        new AssembledTextureFactory()
                .add(ResourceLocation.fromNamespaceAndPath(AstikorCarts.ID, "textures/entity/animal_cart.png"), new AssembledTexture(64, 64)
                        .add(new Material(ResourceLocation.withDefaultNamespace("block/oak_planks"), 16)
                                .fill(0, 0, 60, 38, Material.R0, 0, 2)
                                .fill(0, 28, 20, 33, Material.R90, 4, -2)
                                .fill(12, 30, 8, 31, Material.R270, 0, 4)
                        )
                        .add(new Material(ResourceLocation.withDefaultNamespace("block/stripped_spruce_log"), 16)
                ...
                .add(ResourceLocation.fromNamespaceAndPath(AstikorCarts.ID, "textures/entity/plow.png"), new AssembledTexture(64, 64)
                        .add(new Material(ResourceLocation.withDefaultNamespace("block/oak_planks"), 16)
                ...
                .add(ResourceLocation.fromNamespaceAndPath(AstikorCarts.ID, "textures/entity/supply_cart.png"), new AssembledTexture(64, 64)
                        .add(new Material(ResourceLocation.withDefaultNamespace("block/oak_planks"), 16)
                        ...
                        .add(new Material(ResourceLocation.withDefaultNamespace("block/composter_side"), 16)
                                .fill(16, 47, 44, 5, Material.R0, -2, 1)
                                .fill(16, 54, 38, 5, Material.R0, -2, -6)
                        )
                        .add(new Material(ResourceLocation.withDefaultNamespace("block/composter_top"), 16)
                        ...
                        .add(new Material(ResourceLocation.withDefaultNamespace("block/dirt"), 16)
                                .fill(0, 45, 16, 17)
                        )
                )
                .register(mod.modBus());
