...
public final class PlowScreen extends AbstractContainerScreen<PlowMenu> {
    private static final ResourceLocation PLOW_GUI_TEXTURES = ResourceLocation.fromNamespaceAndPath(AstikorCarts.ID, "textures/gui/container/plow.png");
    ...
    protected void renderBg(final GuiGraphics guiGraphics, final float partialTicks, final int mouseX, final int mouseY) {
        ...
        guiGraphics.blit(RenderType::guiTextured, PLOW_GUI_TEXTURES, i, j, 0, 0, imageWidth, imageHeight, 256, 256);
    }
